                ...
                if ($fetchData) {
                    foreach ($fetchData as $key => $data) {
                        ...
                        <tr>
                            ...
                            <td>Employee ID: <?= $data['eId']; ?></td>
                            <td>Price Quantity: <?= $data['priceQuantity']; ?></td>
                            <td>Product Name: <?= $data['productName']; ?></td>
                            <td>SKU ID: <?= $data['skuId']; ?></td>
                            <td>SKU Quantity ID: <?= $data['skuQtyId']; ?></td>
